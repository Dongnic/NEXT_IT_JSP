...
//	@Pattern(regexp = "패턴")
	...
	public String toString() {
		return "MemberVO [agreeYn=" + agreeYn + ", privacyYn=" + privacyYn + ", memId=" + memId + ", memPass=" + memPass
				+ ", memName=" + memName + ", memMail=" + memMail + ", memBir=" + memBir + ", memZip=" + memZip
				+ ", memAdd1=" + memAdd1 + ", memAdd2=" + memAdd2 + ", memHp=" + memHp + ", memJob=" + memJob
				+ ", memHobby=" + memHobby + ", memMileage=" + memMileage + ", memDelYn=" + memDelYn + ", memJobNm="
				+ memJobNm + ", memHobbyNm=" + memHobbyNm + "]";
	}
