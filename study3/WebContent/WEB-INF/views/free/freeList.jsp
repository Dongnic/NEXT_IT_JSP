	...
	<nav class="text-center">
		<ul class="pagination">
			...
			<c:if test="${searchVO.curPage>=2 }">
				<li><a href="freeList.wow?curPage=${searchVO.curPage-1 }" data-page="${searchVO.curPage-1 }"><span aria-hidden="true">&lt;</span></a></li>
			</c:if>
			...
			<li class="active"><a href="freeList.wow">${i }</a></li>
			</c:if>
			</c:forEach>
